  ...
  describe('Users Route Tests', function () {
    ...
    describe('Authentication Route Config', function () {
      ...
      describe('Verification Route', function () {
        ...
        beforeEach(inject(function ($state) {
          verificationstate = $state.get('verification');
        }));

        it('Should have the correct URL', function () {
          expect(verificationstate.url).toEqual('/verification');
        });

        it('Should not be abstract', function () {
          expect(verificationstate.abstract).toBe(undefined);
        });

        it('Should have templateUrl', function () {
          expect(verificationstate.templateUrl).toBe('/modules/users/client/views/authentication/verification.client.view.html');
        });
      });
